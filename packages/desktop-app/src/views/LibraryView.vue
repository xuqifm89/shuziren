...
const tableConfigs = {
  voiceLibrary: {
    title: '音色库', apiPath: 'voice-library',
    columns: [
  ...
  dubbingLibrary: {
    title: '配音库', apiPath: 'dubbing-library',
    columns: [
      { prop: 'fileUrl', label: '预览', type: 'preview', minWidth: '150', align: 'center' },
      { prop: 'fileName', label: '文件名', minWidth: '200' },
      { prop: 'fileSize', label: '大小', type: 'filesize', minWidth: '100', align: 'center' },
  ...
  musicLibrary: {
    title: '音乐库', apiPath: 'music-library',
    columns: [
      { prop: 'fileUrl', label: '预览', type: 'preview', minWidth: '150', align: 'center' },
      { prop: 'fileName', label: '文件名', minWidth: '200' },
      { prop: 'fileSize', label: '大小', type: 'filesize', minWidth: '100', align: 'center' },
  ...
  portraitLibrary: {
    title: '肖像库', apiPath: 'portrait-library',
    columns: [
      { prop: 'fileUrl', label: '预览', type: 'preview', minWidth: '150', align: 'center' },
      { prop: 'fileName', label: '文件名', minWidth: '200' },
  ...
  copyLibrary: {
    title: '文案库', apiPath: 'copy-library',
    columns: [
  ...
  promptLibrary: {
    title: '提示词库', apiPath: 'prompt-library',
    columns: [
  ...
  workLibrary: {
    title: '作品库', apiPath: 'work-library',
    columns: [
...
<style scoped>
.library-view { display: flex; flex-direction: column; width: 100%; height: 100%; background: rgba(30,30,60,0.7); backdrop-filter: blur(15px); border-radius: 16px; border: 1px solid rgba(102,126,234,0.3); overflow: hidden; padding: 0; }
</style>
